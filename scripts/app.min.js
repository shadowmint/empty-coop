...
function breakpoints() {
    var siteroot = (0, _jquery2.default)('body').attr('data-siteroot');
    ...
    (0, _jquery2.default)('body').append(bpgmarkup);
} /**
   * Breakpoint guide
   */
...
var _breakpointguide = require('./breakpointguide');

var _breakpointguide2 = _interopRequireDefault(_breakpointguide);

var _ie8message = require('./ie8message');

var _ie8message2 = _interopRequireDefault(_ie8message);

var _template = require('./imports/template');
...
(function () {
    ...
    _jquery2.default.each(document.body.className.split(' '), function (index, _class) {
...
(0, _breakpointguide2.default)();

// Sitewide specific code
window.console.log('Lock and loaded');
},{"./breakpointguide":2,"./ie8message":4,"./imports/template":6,"./mediaquery":7,"jquery":1}],4:[function(require,module,exports){
'use strict';
...
var usemessage = false,
    ...
    messagetext = ['We don\'t support this browser, so you may see some visual anomolies whilst using our site. ', 'For a more optimal experience, we\'d recommend a newer version of Internet Explorer' + 'or an alternative, free browser like Chrome or Firefox']; /**
                                                                                                                                                                                                                                                                       * IE8 message
                                                                                                                                                                                                                                                                       */
...
var message = function message(text) {
    (0, _jquery2.default)('body').prepend('<div class="ie8-message">' + '<div class="ie8-message-inner">' + '<h2 class="ie8-message-header">' + messageheading + '</h2>' + '<p>' + messagetext[0] + '</p>' + '<p>' + messagetext[1] + '</p>' + '</div>' + '</div>');
};
...
},{"./foo":5}],7:[function(require,module,exports){
'use strict';
...
var MediaQuery = exports.MediaQuery = (function () {
    ...
    function MediaQuery() {
        ...
        try {
            ...
            var content = (0, _jquery2.default)('head').css('font-family');
            content = content.replace(/""/g, '"');
            this.queries = _jquery2.default.parseJSON(content.substr(1, content.length - 2));
        } catch (e) {}
    }
